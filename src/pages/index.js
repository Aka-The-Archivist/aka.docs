...
export default function Home() {
    ...
    useSWR('https://api.github.com/repos/Aka-The-Archivist/aka.backend/contents/package.json', fetcher, {
        onSuccess: (data) => {
            const parse = JSON.parse(atob(data?.content))
            setVersion(parse.version)
        }
    })
    ...
    return (
        <div className="h-screen bg-gray-900">
            ...
            <div className="relative isolate overflow-hidden">
                ...
                <div className="mx-auto max-w-7xl px-6 pt-10 pb-10 lg:flex lg:px-8 lg:pt-40">
                    <div className="mx-auto max-w-2xl flex-shrink-0 lg:mx-0 lg:max-w-xl lg:pt-8">
                        ...
                        <div className="mt-24 sm:mt-32 lg:mt-16">
                            <div className="inline-flex space-x-6">
                                ...
                                <Link to="/docs/category/getting-started"
                                    ...
                                    <span>Start with v{version}</span>
                                    <ChevronRightIcon className="h-5 w-5 text-gray-500" aria-hidden="true"/>
                                </Link>
                            </div>
                        </div>
                        <h1 className="mt-10 text-4xl font-bold tracking-tight text-gray-100 sm:text-6xl">
                            Fastest Backend Api Framework
                        </h1>
                        <p className="mt-6 text-lg leading-8 text-gray-400">
                            Highly customizable and extensible Node.js framework designed to streamline the development
                            of robust and scalable web applications.
                        </p>
                        <div className="mt-10 flex items-center gap-x-6">
                            ...
                            <a href="https://codesandbox.io/s/github/Aka-The-Archivist/aka.backend/tree/main/?from-embed"
                               target="_blank" className="text-sm font-semibold leading-6 text-white">
                ...
                <div className="mx-auto max-w-7xl px-6 py-4 lg:px-8">
                    <div className="border-t pt-8 md:flex md:items-center md:justify-between">
                        ...
                        <p className="mt-8 text-xs leading-5 text-gray-400 md:order-1 md:mt-0">
                            &copy; 2023 Aka Backend Framework. All rights reserved.
                        </p>
                    </div>
                </div>
            </footer>
